//Import des fonctions d'API et des types necessaires
...
interface ProductsState {
    ...
    // Actions pour fetch les produits :
        ...
        (set, get) => ({
            ...
            fetchCategories: async () => {
                try {
                    ...
                    // Mise à jour du state (donc le store) avec les produits récupérés
                    set({
                        categories,                    // Liste complète des produits
                        // Initialement, les produits filtrés sont la liste complète
                        loading: false               // Désactive le mode de chargement
                    });
                } catch (error: any) {
                    // Enregistre l’erreur et stoppe le chargement
